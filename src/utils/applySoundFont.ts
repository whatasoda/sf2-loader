...
const applySoundFont = async (midi: Buffer, soundfontPath: string, options: ConverterOptions) => {
...
const encodeToMp3 = async (wav: Buffer, options: ConverterOptions): Promise<Buffer> => {
